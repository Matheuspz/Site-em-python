...
class LoginApp:
    def __init__(self, root):
        ...
        # Usuário
        self.label_usuario = tk.Label(self.content_frame, text="Usuario", font=("Arial", 10), bg="#ffffff")
    ...
    def login(self):
        ...
        if usuario and senha:
            ...
            messagebox.showwarning("Atenção", "Usuário e senha devem ser preenchidos")
