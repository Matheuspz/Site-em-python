...
class CadastroApp:
    def __init__(self, root):
        ...
        self.entry_nome = tk.Entry(frame, width=40, font=("Arial", 12))
        ...
        # Confirmar Senha
        self.label_confirmar_senha = tk.Label(frame, text="CONFIRME SUA SENHA", font=("Arial", 10), bg="#9be2cc")
        self.label_confirmar_senha.grid(row=6, column=0, padx=5, pady=5, sticky="w")
        self.entry_confirmar_senha = tk.Entry(frame, width=40, font=("Arial", 12), show="*")
        self.entry_confirmar_senha.grid(row=7, column=0, padx=5, pady=5)

        # Data de Nascimento
        self.label_data_nasc = tk.Label(frame, text="INSIRA SUA DATA DE NASCIMENTO", font=("Arial", 10), bg="#9be2cc")
        self.label_data_nasc.grid(row=8, column=0, padx=5, pady=5, sticky="w")
        self.entry_data_nasc = tk.Entry(frame, width=40, font=("Arial", 12))
        self.entry_data_nasc.grid(row=9, column=0, padx=5, pady=5)
    ...
    def enviar(self):
        ...
        if nome and email and senha and confirmar_senha and data_nasc:
            if senha == confirmar_senha:
                ...
                messagebox.showwarning("Atenção", "As senhas não coincidem. Tente novamente.")                
                self.entry_confirmar_senha.delete(0, tk.END)
        else:
